...
// Reset arena, freeing all allocations from the current channel's identity
// region
...
#define pbox_call2(box, fn, ret_ctype, ret_ptype, ctype0, ptype0, val0, \
                   ctype1, ptype1, val1)                                \
    ({                                                                  \
        ctype0 _a0 = (val0);                                            \
        ctype1 _a1 = (val1);                                            \
...
#define pbox_call3(box, fn, ret_ctype, ret_ptype, ctype0, ptype0, val0, \
                   ctype1, ptype1, val1, ctype2, ptype2, val2)          \
    ({                                                                  \
        ctype0 _a0 = (val0);                                            \
        ctype1 _a1 = (val1);                                            \
        ctype2 _a2 = (val2);                                            \
